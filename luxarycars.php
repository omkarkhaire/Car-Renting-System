...
<body class="">
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd;"">
      ...
      <!-- navbarend -->
      <!-- cardsstart -->
      <h1 class="text-center text-info text-uppercase bg-dark p-3" >luxury cars</h1>
      <p class="text-center text-warning" style="font-size:30px; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;text-transform: capitalize;">enjoy your travel with ultra luxary</p>
                     ...
                     while($row=mysqli_fetch_array($query_run))
                     {
                        ...
                        ?>
                            ...
                            <div class="mx-auto col-lg-3 col-md-6 col-sm-12  mx-auto my-2 text-center ">
                              <div class="card shadow shadow-lg  border border-warning  border-2">
                             <div class="card-body">
                             <img class="mx-auto" src="<?php echo $row['image']; ?>"  alt="..." width="220px" height="220px">
                               ...
                               ?>
                                  ...
                                  <a  href="booking2.php" class="btn btn-outline-primary" name="booknow" onclick="omkar">BOOK NOW</a>
                                  <!-- href="booking2.php" -->
                                </div>
                         </div>
                         </div>
