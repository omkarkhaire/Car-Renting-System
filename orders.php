...
?>
    ...
    <div class="container mt-5 mb-4 mx-auto text-center">
        <div class="conatiner-fluid bg-info"><h1 class="text-center text-uppercase bg-warm" >After completion of orders</h1></div>
        <a href="orderscompleted.php" class=" btn btn-outline-danger">order completed</a>
    </div>
    <div class="container mt-5 mx-auto text-center">
        <div class="conatiner-fluid bg-info"><h1 class="text-center text-uppercase bg-warm" >to add new cars click on the button below</h1></div>
        <a href="adminworkspace.php" class=" btn btn-outline-danger">Add new cars</a>
    </div>
    
    <div class="container mt-5  mb-4mx-auto text-center">
        <div class="conatiner-fluid bg-info"><h1 class="text-center text-uppercase bg-warm" >To Update car details click here</h1></div>
        <a href="update.php" class=" btn btn-outline-danger">Update car</a>
    </div>

    <div class="container mt-5  mb-4mx-auto text-center">
        <div class="conatiner-fluid bg-info"><h1 class="text-center text-uppercase bg-warm" >Check all completed orders</h1></div>
        <a href="oldorders.php" class=" btn btn-outline-danger">check all completed orders</a>
    </div>

    <footer>
    <div class="containers  bg-danger text-center mt-2">
    ***
    </div>
    </footer>
