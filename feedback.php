...
<body class="bg-light">
    ...
    <div class="container-fluid bg-info omkar p-5">
      ...
      <h3 class="text-danger my-auto text-capitalize text-center"> please let us Know what you felt about our services</h3>
    ...
    <div class="container mt-4 bg-light">
        ...
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="exampleFormControlTextarea1" name="feed" rows="3"></textarea>
          </div>

          <input type="submit" class="btn btn-outline-danger" value="Submit Feedback">
