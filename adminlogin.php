...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd;"">
    ...
    <a class="navbar-brand " href="#">
      ...
      <span class="display-6 text-primary" style="font-family: 'Times New Roman', Times, serif;">AUTORENT ADMIN</span>
    </a>
   ...
   <h1 class="text-center bg-info text-danger text-uppercase" style="font-size: 55px;">welcome admin</h1>

   <div class="container-fluid p-1 text-center  shadow shadow-lg rounded">
   ...
   <div class="container bg-secondary shadow shadow-lg rounded" id="omkar">
      <h2 class="text-center  text-white text-uppercase mt-4" style="font-size: 45px; font-family:Lobster;">login</h2>
   <div class="container">
