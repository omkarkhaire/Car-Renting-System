...
<body class="bg-light">
  ...
  <div class="container card  border border-4 p-3 shadow-lg rounded border-info mb-5">
    ...
    <form method="post" action="bookingphpecars.php" class="row g-3 text-capitalize">
      <div class="col-md-6">
 ...
 else
 {
   ...
   if($check_cars)
   {
      ...
      <div class="col-12">
        ...
        <!-- <button class="btn btn-primary" onclick="getLocation()">Track By GPS</button> -->
      </div>
...
<script async defer
  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCLI4hlhD-wvMlyCO4PBsXVH2i_48E1IBU&callback=initMap"
...
<script>
  ...
  function showPosition(position) {
    ...
    // "+latlon+"&zoom=14&size=400x300&sensor=false&key=AIzaSyCLI4hlhD-wvMlyCO4PBsXVH2i_48E1IBU";

    var api = "https://maps.googleapis.com/maps/api/geocode/json?latlng=" + position.coords.latitude + "," + position.coords.longitude + "&sensor=true&key=AIzaSyB-Ink86mmpSRRwf0wfbM-xdpEv-Qv5W9o";
    console.log(api);
    //j query
    $.get({
...
// var api="http://maps.googleapis.com/maps/api/geocode/json?latlng="+position.coords.latitude+","+position.coords.longitude+"&sensor=true";
//   var omkar = "Latitude: " + position.coords.latitude + 
