...
if ($conn->query($sql) === TRUE) {
  ...
  ?>
         <div style="background-color:gold;text-align:center;padding:10%">
           <h1 style="font-size:35px;color:green"  class="text-uppercase"> Order Cancelled Successfully </h1>
           </div>
...
<div class="container mt-5 mx-auto text-center">
        <a href="myorders.php" class=" btn btn-outline-danger px-4 py-2 text-uppercase">back</a>
    </div>
