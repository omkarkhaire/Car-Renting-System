...
<body class="bg-info">
    ...
    <div class="container  login mx-auto w-40  border border-5 pb-5 pl-5 pr-5 pt-2 bg-light shadow-lg mb-4 mt-4 ">
      ...
      <h6 class="text-center mt-0 font-italic text-muted " >Renting Car Made Easy</h6>
        ...
        <div class="mt-3">
          <p>New To AUTORENT ? <a href="signup.php"> Sign Up</a></p>
        </div>
